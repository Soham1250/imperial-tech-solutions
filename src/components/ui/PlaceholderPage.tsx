...
export const PlaceholderPage: React.FC<PlaceholderPageProps> = ({ title, description }) => {
    return (
        <PageLayout>
            <div className="min-h-screen bg-[#fdfaf3] flex flex-col items-center justify-center p-6 text-center">
                <div className="max-w-3xl w-full">
                    ...
                    <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-border pt-12">
                        <div className="p-6 rounded-2xl bg-white border-2 border-primary/10 shadow-sm">
