...
export const Hero = () => {
    ...
    // Parallax values for the landing page reveal
    // Assuming the ScrollIntro is roughly 250vh (2.5 * windowHeight)
    // We start showing the landing page when scroll is > 1.5 * height
    const heroOpacity = useTransform(scrollY, [0, 1000, 1800], [0, 0, 1]);
    const heroY = useTransform(scrollY, [0, 1000, 1800], [100, 50, 0]);
    const heroScale = useTransform(scrollY, [0, 1000, 1800], [0.95, 0.98, 1]);
